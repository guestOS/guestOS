...
// Modified for O2Context_AntiGran to match default Cocotron GDI fonts default value
// and to get glyph by glyph index, and not ASCII code
...
namespace agg
{
    ...
    font_engine_win32_tt_base::font_engine_win32_tt_base(bool flag32, 
        ...
        m_pitch_and_family(DEFAULT_PITCH|FF_DONTCARE),
        m_hinting(true),
        m_flip_y(false),
